...
reactIs_production_min.isValidElementType = function(a) {
  return "string" === typeof a || "function" === typeof a || a === e$2 || a === m$1 || a === g || a === f || a === p$2 || a === q$2 || "object" === typeof a && null !== a && (a.$$typeof === t$3 || a.$$typeof === r$3 || a.$$typeof === h$2 || a.$$typeof === k$1 || a.$$typeof === n$2 || a.$$typeof === w$1 || a.$$typeof === x || a.$$typeof === y || a.$$typeof === v$1);
};
...
function buildSVGAttrs(state2, {
  ...
  buildHTMLStyles(state2, latest2, options, transformTemplate2);
  if (isSVGTag2) {
...
function getCurrent(visualElement) {
  const current2 = {};
  visualElement.values.forEach((value, key) => current2[key] = value.get());
  return current2;
}
  ...
  return {
    ...
    next: (t2) => {
      ...
      if (!isResolvedFromDuration) {
        ...
        if (t2 !== 0) {
          if (dampingRatio < 1) {
            currentVelocity = calcGeneratorVelocity(resolveSpring, t2, current2);
          } else {
            currentVelocity = 0;
          }
        }
...
const correctBorderRadius = {
  correct: (latest2, node2) => {
    ...
    const x2 = pixelsToPercent(latest2, node2.target.x);
    const y2 = pixelsToPercent(latest2, node2.target.y);
    return `${x2}% ${y2}%`;
  }
};
...
function resolveCSSVariables(visualElement, { ...target }, transitionEnd) {
  ...
  visualElement.values.forEach((value) => {
    ...
    if (!isCSSVariableToken(current2))
      return;
    const resolved = getVariableValue(current2, element);
    if (resolved)
      value.set(resolved);
  });
  for (const key in target) {
...
const motion = /* @__PURE__ */ createMotionProxy((Component2, config2) => createDomMotionConfig(Component2, config2, preloadedFeatures, createDomVisualElement));
...
function createStandaloneToast({
  ...
  const ToastContainer = () => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider2, { theme: theme2, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ColorModeContext.Provider, { value: colorModeContextValue, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    ToastProvider,
    {
      defaultOptions,
      motionVariants,
...
var isElement$2 = (el2) => typeof el2 == "object" && "nodeType" in el2 && el2.nodeType === Node.ELEMENT_NODE;
function getNextIndex(current2, max2, loop) {
  let next2 = current2 + 1;
  if (loop && next2 >= max2)
    next2 = 0;
  return next2;
}
function getPrevIndex(current2, max2, loop) {
  let next2 = current2 - 1;
  if (loop && next2 < 0)
    next2 = max2;
  return next2;
...
var [AccordionStylesProvider, useAccordionStyles] = createContext$1({
  name: "AccordionStylesContext",
  hookName: "useAccordionStyles",
  providerName: "<Accordion />"
});
var [AccordionItemProvider, useAccordionItemContext] = createContext$1({
...
var [AccordionProvider, useAccordionContext] = createContext$1({
...
var variants = {
  exit: ({
    ...
    return {
      ...
      transition: (_a4 = transition2 == null ? void 0 : transition2.exit) != null ? _a4 : withDelay.exit(defaultTransitions.exit, delay2)
    };
  },
  enter: ({
    animateOpacity,
    ...
    return {
      ...
      transition: (_a4 = transition2 == null ? void 0 : transition2.enter) != null ? _a4 : withDelay.enter(defaultTransitions.enter, delay2)
    };
  }
};
...
function useRadioGroup(props = {}) {
  ...
  const [valueState, setValue] = reactExports.useState(defaultValue || "");
  ...
  const getRadioProps = reactExports.useCallback(
    (props2 = {}, ref2 = null) => {
...
var [RadioGroupProvider, useRadioGroupContext] = createContext$1({
...
var RadioGroup = forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RadioGroupProvider, { value: group, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    chakra.div,
    {
...
function useRadio(props = {}) {
  ...
  const uuid = `radio-${reactExports.useId()}`;
  ...
  const [isFocusVisible2, setIsFocusVisible] = reactExports.useState(false);
  const [isFocused, setFocused] = reactExports.useState(false);
  const [isHovered, setHovering] = reactExports.useState(false);
  const [isActive, setActive] = reactExports.useState(false);
  const [isCheckedState, setChecked] = reactExports.useState(Boolean(defaultChecked));
...
var Radio = forwardRef((props, ref) => {
  ...
  const name = (_a4 = props == null ? void 0 : props.name) != null ? _a4 : group == null ? void 0 : group.name;
  const {
    getInputProps,
    getCheckboxProps,
    getLabelProps,
  ...
  const [layoutProps, otherProps] = split$1(htmlProps, layoutPropNames);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(chakra.label, { className: "chakra-radio", ...rootProps, __css: rootStyles, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "chakra-radio__input", ...inputProps }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      chakra.span,
      {
...
var Tag = forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TagStylesProvider, { value: styles2, children: /* @__PURE__ */ jsxRuntimeExports.jsx(chakra.span, { ref, ...ownProps, __css: containerStyles }) });
});
Tag.displayName = "Tag";
var TagLabel = forwardRef((props, ref) => {
  const styles2 = useTagStyles();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(chakra.span, { ref, noOfLines: 1, ...props, __css: styles2.label });
});
...
function isDraftable(value) {
  ...
  if (!value)
    return false;
  return isPlainObject(value) || Array.isArray(value) || !!value[DRAFTABLE] || !!((_a4 = value.constructor) == null ? void 0 : _a4[DRAFTABLE]) || isMap(value) || isSet(value);
}
...
function readPropFromProto(state2, source, prop) {
  ...
  return desc ? `value` in desc ? desc.value : (
    ...
    (_a4 = desc.get) == null ? void 0 : _a4.call(state2.draft_)
  ) : void 0;
}
...
function e$1(n2, t2, o) {
  var i = reactExports.useMemo(function() {
    return produce(n2);
  }, [n2]);
  return reactExports.useReducer(i, t2, o);
}
var DefaultContext = {
  color: void 0,
  size: void 0,
...
const createStoreImpl = (createState2) => {
  ...
  const destroy = () => {
    if (({ "BASE_URL": "/sopg-v3", "MODE": "production", "DEV": false, "PROD": true, "SSR": false } ? "production" : void 0) !== "production") {
      console.warn(
...
function useStore(api, selector = api.getState, equalityFn) {
  if (({ "BASE_URL": "/sopg-v3", "MODE": "production", "DEV": false, "PROD": true, "SSR": false } ? "production" : void 0) !== "production" && equalityFn && !didWarnAboutEqualityFn) {
    console.warn(
...
const createImpl = (createState2) => {
  if (({ "BASE_URL": "/sopg-v3", "MODE": "production", "DEV": false, "PROD": true, "SSR": false } ? "production" : void 0) !== "production" && typeof createState2 !== "function") {
    console.warn(
...
function BsClipboardCheckFill(props) {
...
function BsClipboardXFill(props) {
...
export {
  ...
  FaFileDownload as K,
  LuDices as L,
  MdOutlineCloudUpload as M,
  Link as N,
  FaGithub as O,
  AccordionItem as P,
  AccordionButton as Q,
  Radio as R,
  Switch as S,
  Tooltip as T,
  AccordionIcon as U,
  ...
  Accordion as Z,
  HStack as _,
  accordionAnatomy as a,
  React as a0,
  ChakraProvider as a1,
  ColorModeScript as a2,
  cssVar as b,
  createMultiStyleConfigHelpers as c,
  defineStyleConfig as d,
  switchAnatomy as e,
  defineStyle as f,
  extendTheme as g,
  createStandaloneToast as h,
  inputAnatomy as i,
  create as j,
  immer as k,
  ...
  reactExports as o,
  BsClipboard as p,
  BsClipboardCheckFill as q,
  radioAnatomy as r,
  selectAnatomy as s,
  tagAnatomy as t,
  useColorModeValue as u,
  BsClipboardXFill as v,
  lib as w,
  Button as x,
  e$1 as y,
  Input as z
